...
@section('container')
	<div class="homepage hexagons text-center">
		<div class="container">
			...
			<h2 class="c-white small m-b-25">Мы верим, что процесс разработки только тогда наиболее продуктивен, когда работа с фреймворком приносит радость и удовольствие.<br>Счастливые разработчики пишут лучший код.</h2>
			<ul class="inline">
				<li>
